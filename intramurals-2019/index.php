      ...
      <div class="cc-cont col-100 flex align-start">
        <div class="cc">
          ...
          <ol>
            ...
            <li>Theme color of CCS (purple and mustard yellow) must be applied in the design</li>
            <li>CCS logo must be present in the design</li>
            <li>Submission of entries will begin on June 24, 2019 and will end on July 8, 2019</li>
            <li>Submit your entries at <a href="http://psits.com/intramurals-2019/">
            http://psits.com/intramurals-2019/ &nbsp;<i class="fal fa-external-link"></i></a>. Alternatively, your may email your entry at markjudaya@yahoo.com</li>
          </ol>
          <p>Note: Contestants must be a student from CCS department.</p><br>
          </ol>
          <h2>CCS LOGO</h2><br>
          <div class="text-center col-100">
              <img src="/img/ccs-logo.png" alt="" width="60%" />
          </div>
        ...
        <div class="cc">
            ...
            <?php if ($ticket): ?>
              ...
              <?php elseif(file_exists("./entries/$user.png")): ?>
                <h2>Your entry</h2>
            ...
            <br><br>
            <?php endif; ?>
          <a class="button" href="javascript:$(document).scrollTop($('.bb-wrap').offset().top-($(window).height()/2))">Entries</a>
        </div>
        ...
        <div class="col-100 thumbnails">
          <div class="bb col-100">
            <div class="bb-wrap flex justify-center align-start flex-wrap">
              <h2 class="col-100 text-center">Entries</h2>
        ...
        <div style="width: 95%;margin:55px auto;">
          ...
          <ul>
            ...
            <li>How can I submit my entry?
              <br>
              <b>+ You can submit your entry by uploading a jpg/png file <a href="javascript:$(document).scrollTop($('#upload').offset().top-($(window).height()/2))">here</a></b>
            </li>
    ...
    $('.ajax-link').each(function(){
      $(this).click(function(e){
        ...
        $.ajax({
          ...
          url: $(this).attr('href'),
          beforeSend: function(){
              that.html(`<img src="/dashboard/img/spinner.svg" style="width: 40px!important;margin-bottom:-13px;"/>`)
          },
